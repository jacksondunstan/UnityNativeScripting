...
#pragma warning restore 649
        ...
        static bool CheckParametersMatch(
            ...
            System.Reflection.ParameterInfo[] reflectionParams)
        {
            if (reflectionParams == null || paramTypeNames == null)
            {
                Debug.LogError("Please, check if you have added ParamTypes to the json as it is currently null ! The generation will fail !");
            }
            // Length must match
